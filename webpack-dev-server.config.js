...
const defaultBrand = process.env.BRAND || 'flux';
  ...
  config.plugins = [
    ...
    new webpack.DefinePlugin({
      'process.env': {
        ...
        APP_VERSION: JSON.stringify('6.0.1'),
        HOSTING_URL: JSON.stringify('https://dev.flux.net.br/fluxphone/fluxsip'),
        PREFIX: JSON.stringify('flux'),
        BRAND: JSON.stringify('flux'),
        BRAND_CONFIGS: JSON.stringify(brandConfigs),
        ERROR_REPORT_KEY: JSON.stringify(errorReportKey),
        RECORDING_LINK: JSON.stringify('https://dev.flux.net.br/flux-media-reader/'),
